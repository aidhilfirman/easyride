      ...
      <div className="flex min-h-screen">
        ...
        <aside className="hidden w-64 shrink-0 border-r border-slate-200/60 bg-white p-5 lg:flex lg:flex-col sticky top-0 h-screen">
          ...
          <nav className="space-y-1">
            <button onClick={function () { openDashboard(); }} className="w-full flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-500 hover:bg-slate-50 hover:text-slate-700 transition">
      ...
      <div className="flex min-h-screen">
        ...
        <aside className="hidden w-64 shrink-0 border-r border-slate-200/60 bg-white p-5 lg:flex lg:flex-col sticky top-0 h-screen">
          ...
          <nav className="space-y-1">
            ...
            <button onClick={function () { setPage("ack"); }} className="w-full flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-500 hover:bg-slate-50 hover:text-slate-700 transition">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              Trips Ack Tracker
            </button>
          </nav>
